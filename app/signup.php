...
if (!empty($_SESSION['user_id'])) {
    ...
    if (isset($_POST['btn_register'])) {
        ...
        if(!$register->create_user($_POST)){
            $_SESSION['msg'] = 'Error in creating an Account. Try Again.';
        }else{
             $register->login_user($user_name, $password);
        }
    }else{
        session_destroy();
    }
                ...
                <div class="row flex-row h-100 bg-white">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-7 my-auto p-0">
                        <div class="authentication-form mx-auto" style="padding: 0;">
                            ...
                            <p class="text-center">Register to SCSES</p>
                            ...
                            <form action="" method="post">
                                ...
                                ?>
                                <div class="sign-btn text-center" style="margin-top: -5px;">
                                    <button type="submit" class="btn btn-theme btn-block" name="btn_register"><i class="ik ik-unlock"></i>Register</button> 
                                </div>                                
                                <div class="form-group display-6 text-center">
                                    <a href="login.php" class="nav-link text-info"><i class="ik ik-unlock"></i> Already Registered?</a>
                                </div>
                            </form> 
                        </div>
                    </div>
